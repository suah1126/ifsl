...
class DatasetPASCAL(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        rename_class = lambda x: _support_classes.index(x) - 6 if x in _support_classes else 0
...
#        print(query_name) : 000054352
        ...
        # s_img_pil.save('./example/s_'+query_name+'.jpg', 'JPEG')
    ...
    def get_query_box(self, org_imsize, query_imsize, query_cbox, rename_class):
        ...
        for box in query_cbox:
            ...
            query_box[clsid-1][cls_idx[clsid-1]][0] = clsid
            cls_idx[clsid-1] += 1
            if sum(cls_idx) >= 50:
                break
