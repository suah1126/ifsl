...
def main(args):
    ...
    seed = int(time.time())
    torch.manual_seed(1670573408)
    torch.cuda.manual_seed(1670573408)
    pytorch_lightning.utilities.seed.seed_everything(1670573408)
    # Method
...
if __name__ == '__main__':
    ...
    parser.add_argument('--niter', type=int, default=400, help='Max iterations')
